...
% large picture
\element{check-pic}{
  \begin{question}{Qsimple:large-pic}
    Let consider a large picture, can we render it with a sufficient quality?
    %amc2moodle \SetOption{imgResolution}{72}  
    \begin{center}
      \includegraphics[width=0.5\textwidth]{./Figures/other/large.JPG}
    \end{center}
  ...
  \end{question}
  %medium-size picture
  \begin{question}{Qsimple:medium-pic}
    Let consider a medium-size picture, can we render it with a sufficient quality?
    %amc2moodle \SetOption{imgResolution}{100}  
    \begin{center}
      \includegraphics[width=0.5\textwidth]{./Figures/other/medium.JPG}
    \end{center}
  ...
  \end{question}
  %vectorial picture
  \begin{question}{Qsimple:vec-pic}
    Let consider a vectorial picture, can we render it with a sufficient quality?
    %amc2moodle \SetOption{imgResolution}{200}  
    \begin{center}
      \includegraphics[width=0.5\textwidth]{./Figures/other/vect.pdf}
    \end{center}
