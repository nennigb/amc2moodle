...
\element{check-pic}{
  \begin{question}{Qsimple:large-pic}
    Soit une image un peu lourde, peut-on vérifier le rendu

    \begin{center}
      \includegraphics[width=0.5\textwidth]{./Figures/other/large.png}
    \end{center}

    \begin{reponses}
      \bonne{c'est du lourd}
      \mauvaise{ou pas}
    \end{reponses}
  \end{question}
  \begin{question}{Qsimple:medium-pic}
    Soit une image moyennement lourde, peut-on vérifier le rendu
  ...
  \begin{question}{Qsimple:vec-pic}
    Soit une image vectorielle, peut-on vérifier le rendu

    \begin{center}
      \includegraphics[width=0.5\textwidth]{./Figures/other/vect.JPG}
    \end{center}
